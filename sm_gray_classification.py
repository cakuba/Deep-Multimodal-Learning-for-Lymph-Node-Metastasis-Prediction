...
def classification_model(size, epochs, train_dir, valid_dir=None, batch_size=32, shuffle=True, show_summary=True, weights_path="./weights/"):
    ...
    model_name = 'InceptionResNetV2_GRAY.{epoch:03d}.h5'
...
size = (250,250)
epochs = 1000
train_dir = "./data/SingleModality/training/B-mode"
valid_dir = "./data/SingleModality/valid/B-mode"
history = classification_model(size,epochs,train_dir,batch_size=64,valid_dir=valid_dir,show_summary=True)

history_saved = True
if history_saved:
   history_file = os.path.join('./history', 'sm_gray_history-epoch-'+str(epochs)+'.dat')
